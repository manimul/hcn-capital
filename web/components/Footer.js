        ...
        <div className="container  mx-auto flex   flex-col pb-12 px-12 md:flex-row md:py-52 text-white md:space-x-16 ">
          <div className="md:w-3/4 space-y-4  ">
            ...
            <div className="text-xl space-y-4">
              <p className="">
                Do you have a business case you’d like to share, get in touch – it might be a
                perfect fit for our portfolio.
              </p>
              ...
              <div className="flex space-x-4">
                ...
                <div>
                  <span className="text-[#E8B127] text-md  font-sans  block">Address</span>
          ...
          <div className="[contact form section] md:w-2/3  flex flex-col shadow-3xl rounded-md">
            <form className="bg-white  h-auto  p-8 text-black">
              <h2 className="text-2xl  font-sans ">Book your meeting now</h2>
              ...
              <fieldset className="flex flex-col">
                ...
                ></textarea>
                <button className="mt-8 text-white  bg-none border-2 bg-[#E8B127]  border-[#E8B127]  py-5  inline-block tracking-wide  font-sans font-semibold ">
                  Send message
                </button>
              </fieldset>
            </form>
