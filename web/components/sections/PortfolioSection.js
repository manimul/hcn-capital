      ...
      <section className="mx-auto space-y-4 bg-gradient-to-br from-gray-50 to-yellow-50">
        <div className="px-8 py-32 mx-auto">
          <div className="max-w-xl mx-auto text-center mb-12">
            ...
            <h2
              className={`text-5xl my-4 font-medium tracking-tight  font-sans mb-4  capitalize {styles.heading}`}
            >
              {heading}
            </h2>
            {text && (
                      ...
                      <a href={portfolio.slug.current}>
                        <div className="relative bg-black">
                          ...
                          <img
                            ...
                            loading="lazy"
                            width={700}
                            className="h-96   w-full object-cover opacity-60   transition duration-500  "
                            alt={heading}
                          />
                          ...
                          >
                            ...
                            <span className="text-white text-lg">See Portfolio</span>
                          </a>
                        </div>
                      </a>
                    </div>
